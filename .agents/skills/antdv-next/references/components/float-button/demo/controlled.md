...
<template>
  ...
  <a-float-button-group :open="open" trigger="click" style="inset-inline-end: 24px;">
    <template #icon>
  ...
  <a-float-button-group :open="open" shape="square" trigger="click" style="inset-inline-end: 88px;">
    <template #icon>
      <CustomerServiceOutlined />
    </template>
    <a-float-button />
