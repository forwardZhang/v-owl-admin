...
<template>
  <div>
    <a-radio-group v-model:value="sizeBucket" style="margin-bottom: 16px">
      <a-radio-button :value="1"> Size Bucket 1 </a-radio-button>
      <a-radio-button :value="2"> Size Bucket 2 </a-radio-button>
    </a-radio-group>
    <a-splitter :key="sizeBucket" style="height: 300px;  box-shadow: 0 0 10px rgba(0, 0, 0, 0.1)">
      <a-splitter-panel
      ...
      <a-splitter-panel :min="SIZE_BUCKETS?.[1]?.min" :max="SIZE_BUCKETS?.[1]?.max">
        <a-flex justify="center" align="center" style="height: 100%">
          <a-typography-title type="secondary" :level="5" style="white-space: nowrap">
            Second
          </a-typography-title>
