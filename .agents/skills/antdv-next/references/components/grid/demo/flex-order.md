...
```vue
<template>
  <a-divider title-placement="left"> Normal </a-divider>
  ...
  <a-divider title-placement="left"> Responsive </a-divider>
  <a-row class="row-demo">
    ...
    <a-col :span="6" :xs="{ order: 3 }" :sm="{ order: 4 }" :md="{ order: 2 }" :lg="{ order: 1 }">
      3 col-order-responsive
    </a-col>
    <a-col :span="6" :xs="{ order: 4 }" :sm="{ order: 3 }" :md="{ order: 1 }" :lg="{ order: 2 }">
