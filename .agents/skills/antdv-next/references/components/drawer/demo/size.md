...
<template>
  <a-space>
    <a-button type="primary" @click="showDefaultDrawer"> Open Default Size (378px) </a-button>
    <a-button type="primary" @click="showLargeDrawer"> Open Large Size (736px) </a-button>
  </a-space>
  <a-drawer
    v-model:open="open"
    :title="`${size} Drawer`"
