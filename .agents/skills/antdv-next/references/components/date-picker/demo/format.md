...
const rangeValue = shallowRef([dayjs('2015/01/01', dateFormat), dayjs('2015/01/01', dateFormat)]);
...
<template>
  <a-space vertical :size="12">
    ...
    <a-date-picker v-model:value="monthValue" picker="month" :format="monthFormat" />
    <a-date-picker v-model:value="weekValue" picker="week" :format="customWeekStartEndFormat" />
    <a-range-picker v-model:value="rangeValue" :format="dateFormat" />
