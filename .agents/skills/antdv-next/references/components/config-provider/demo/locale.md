...
<template>
  ...
  <a-config-provider :locale="locale">
    ...
    >
      ...
      <div
        :style="{ width: '320px', border: `1px solid ${token.colorBorder}`, borderRadius: '8px' }"
      >
      ...
      <a-upload v-model:file-list="fileList" list-type="picture-card">
        <div style="padding: 8px 0">Upload</div>
      </a-upload>
      <a-divider title-placement="start"> Tour </a-divider>
      <a-button type="primary" @click="tourOpen = true"> Begin Tour </a-button>
      <a-space>
        <a-button ref="tourRef1"> Upload </a-button>
        <a-button ref="tourRef2" type="primary"> Save </a-button>
