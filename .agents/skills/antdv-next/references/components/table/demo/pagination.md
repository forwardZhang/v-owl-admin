...
<template>
  <div>
    <div>
      <a-radio-group v-model:value="top" style="margin-bottom: 10px" :options="topOptions" />
    </div>
    <a-radio-group v-model:value="bottom" style="margin-bottom: 10px" :options="bottomOptions" />
